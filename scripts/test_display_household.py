...
class TestHousehold(unittest.TestCase):
    ...
    def test_display_household(self):
        ...
        expected = ''.join((
            ...
            '<ul>',
            '<li><img src="https://avatars.planningcenteronline.com/uploads/person/36729400-1524683747/avatar.2.jpeg" alt="Rob Kocher"/><span data-primary>Rob Kocher</span>,</li>',
